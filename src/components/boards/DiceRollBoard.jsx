  ...
  return (
    <Stack flexGrow={1} justifyContent="center" alignItems="center" gap={2}>
      ...
      {move[opponentPlayerIdx] !== null ? (
        <Box src={mapping[move[opponentPlayerIdx]]} component="img" height="240px" width="240px" sx={{ bgcolor: "#E5E4E2", p: "12px", borderRadius:"24px" }} />
      ) : (
        <Box height="240px" width="240px" sx={{ border: "2px solid red", p: "12px", borderRadius:"24px" }} />
      )}

      {move[myPlayerIdx] !== null ? (
        <Box src={mapping[move[myPlayerIdx]]} component="img" height="240px" width="240px" sx={{ bgcolor: "#E5E4E2", p: "12px", borderRadius:"24px" }} />
      ) : (
        <Box height="240px" width="240px" sx={{ border: "2px solid red", p: "12px", borderRadius:"24px" }} />
      )}
